...
If the task needs a *component* rather than an animation — a toast, a drawer, a command menu, a dropdown — inspect and reuse the project's established component library. If none exists, report that product-level choice instead of silently installing or hand-rolling one.
