...
- 외부 host의 실제 등록 요청은 canonical 3경로 준비를 허용하되, 커밋은 정확한 경로의 별도 사용자 승인 뒤에만 수행합니다.
